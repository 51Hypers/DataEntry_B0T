...
class Form:
    ...
    def enterPayload(self):
        try:
            ...
            drop_down_faulty1 = Select(self.driver.find_element(By.XPATH,'//*[@id="dl_application_type"]'))
            drop_down_faulty1.select_by_index(0)
            self.driver.find_element(By.XPATH,'//*[@id="txt_license_no"]').send_keys("Faulty123")
            drop_down_faulty2 = Select(self.driver.find_element(By.XPATH,'//*[@id="dl_firm_type"]'))
            drop_down_faulty2.select_by_index(0)
            drop_down_faulty3 = Select(self.driver.find_element(By.XPATH,'//*[@id="dl_type_of_ownership"]'))
            drop_down_faulty3.select_by_index(0)
            self.driver.find_element(By.XPATH,'//*[@id="txt_applicant_name"]').send_keys("FaultyPDF")
            self.driver.find_element(By.XPATH,'//*[@id="txt_father_name"]').send_keys("FaultyPDF")
            self.driver.find_element(By.XPATH,'//*[@id="txt_mobile"]').send_keys("1234567890") 
            self.driver.find_element(By.XPATH,'//*[@id="txt_applicant_address"]').send_keys("FaultyPDF")
            self.driver.find_element(By.XPATH,'//*[@id="txt_business_name"]').send_keys("FaultyPDF")
            self.driver.find_element(By.XPATH,'//*[@id="txt_nature_of_business"]').send_keys("FaultyPDF")
            self.driver.find_element(By.XPATH,'//*[@id="txt_establishment_date"]').send_keys("12/8/2023")   
