...
def main():
    ...
    try:
        ...
        browser.find_element(By.XPATH,
                             "/html/body/form/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/table/tbody/tr/td[8]/a[1]").click()
    except:
        attendance_button = browser.find_element(By.XPATH,
    ...
    for i in range(20):
        view_file_button = browser.find_element(By.XPATH,
                                                "/html/body/form/div[4]/div[2]/div/div[2]/div/div[2]/div/div/table/tbody/tr[1]/td[2]/a")
        ...
        for i in truncated_final_labellist:
            try:
                ...
                final_ids_dict.update(
                    {final_labellist[truncated_final_labellist.index(i)]: input_ids[truncated_input_ids.index(var[0])]})
            except:
                continue
        for i in truncated_final_labellist:
            try:
                var = difflib.get_close_matches(i, truncated_select_ids)
                final_ids_dict.update({final_labellist[truncated_final_labellist.index(i)]: select_ids[
                    truncated_select_ids.index(var[0])]})
            except:
                continue
        for i in truncated_final_labellist:
            try:
        ...
        indices = [i for i, x in enumerate(values) if x == "Address"]
        a=['Applicant', 'Application']
        if any(ext in values[0] for ext in a):
            values[indices[0]]='Applicant Address'
            values[indices[1]]='Business Address'
        else:
            values[indices[1]]='Applicant Address'
            values[indices[0]]='Business Address'
        ...
        for i in truncated_final_labellist:
            try:
                ...
                final_values_dict.update(
                    {final_labellist[truncated_final_labellist.index(i)]: values[truncated_values.index(var[0]) + 1]})
            except:
                continue
        ...
        submit_button = browser.find_element(By.XPATH,
                                             "/html/body/form/div[4]/div[2]/div/div/div/div[2]/div[2]/div[1]/div[41]/div/input")
        ...
        # This EXCEPT is replicating the payload inputing function with default values for FAULTY PDFs
            ...
            final_values_dict = {'Application Type': 'New Licence', 'License No.': 'RAN22020119159408',
                                 'Firm Type': 'Proprietary',
                                 'Type of Ownership of Business Premises': 'On Rent', 'Applicant Name': 'FAULTY PDF',
                                 "Father's Name": 'RAM',
                                 'Mobile No.': '9576131033', 'Applicant Address': 'ADRESSS',
                                 'Name of Business': 'BUISNESS',
                                 ' Nature of Business/Brief Description of Business': 'SHOP',
                                 ' Date of Establishment': '05-01-2019',
